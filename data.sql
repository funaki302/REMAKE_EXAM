...
select vc.* , e.date_emprunt,e.date_retour,m.nom as emprunteur,m.id_membre as id_emprunter 
from v_all_info_categorie vc 
join emprunt e on vc.id_objet = e.id_objet
